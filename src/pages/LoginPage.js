...
export default function LoginPage({ onLogin }) {
  ...
  function getUsers() {
    return JSON.parse(localStorage.getItem('mindbridge_users') || '[]');
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1,
        background: 'linear-gradient(160deg, #0a1628 0%, #0f2744 50%, #1a3a5c 100%)',
        display: 'flex',
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', marginBottom: '48px' }}>
          <div style={{
            ...
            background: 'linear-gradient(135deg, #2E75B6, #5ba3d9)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '48px', margin: '0 auto 24px',
            boxShadow: '0 20px 60px rgba(46,117,182,0.4)',
          }}>
            💙
          </div>
          <h1 style={{ color: 'white', fontSize: '38px', fontWeight: '800', margin: '0 0 8px', letterSpacing: '-1px' }}>
            MindBridge
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '16px', margin: '0 0 48px' }}>
        ...
        <p style={{ position: 'relative', zIndex: 1, color: 'rgba(255,255,255,0.3)', fontSize: '11px', marginTop: '32px', textAlign: 'center', lineHeight: '1.6' }}>
          For all university students in the UK<br />Home · EU · International
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '360px' }}>
          ...
          {!isLogin && (
            <div style={{ marginBottom: '16px' }}>
              ...
              <input
                ...
                placeholder="e.g. Prestha Khanal"
          ...
          <button
            ...
            disabled={loading}
            style={{ width: '100%', padding: '14px', background: loading ? '#94a3b8' : 'linear-gradient(135deg,#2E75B6,#0f2744)', color: 'white', border: 'none', borderRadius: '12px', fontSize: '15px', fontWeight: '700', cursor: loading ? 'not-allowed' : 'pointer', boxShadow: loading ? 'none' : '0 8px 24px rgba(46,117,182,0.35)' }}
          >
